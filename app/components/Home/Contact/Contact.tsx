        ...
        <div>
          ...
          <div className="mt-7">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">01063928293</p>
            </div>
            <div className="flex items-center space-x-3 mb-4">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">Sohag, Cairo</p>
            </div>
          </div>
          {/* social icons */}
          <div className="flex items-center mt-8 space-x-3">
            ...
            <div
              className="w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center 
            cursor-pointer flex-col hover:bg-red-700 transition-all duration-300"
            >
              <FaYoutube className="text-white w-6 h-6" />
            </div>
            <div
              className="w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center
             cursor-pointer flex-col hover:bg-sky-500 transition-all duration-300"
            >
